                            ...
                            @if(count($list) > 0)
                                @foreach ($list as $list_data)
                                    ...
                                    <tr id="tr_<?=$list_data->id;?>">
                                        ...
                                        <td>{{ $sl++ }}</td>
                                        <td class=""><a href="<?= url('/').'/'.$list_data->user_id.'/user-information'?>">{{ $list_data->first_name.' '.$list_data->last_name}}</a></td>
                                        <td class=""><a href="<?= url('/').'/'.$list_data->id.'/package-details'?>">{{ $list_data->title}}</a></td>
