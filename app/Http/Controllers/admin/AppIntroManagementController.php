...
class AppIntroManagementController extends Controller
{
    public function app_intro_view()
    {
        ...
        return view("admin.intro.app_intro_view",compact('info'));
    }
    ...
    {
        return view("admin.intro.app_intro_create");
    }
    ...
    public function intro_store(Request $request)
    {
        ...
        if($create){
            return redirect('app-intro')->with('success','New Intro has been created');
        }else{
