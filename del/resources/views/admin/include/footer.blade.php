    ...
    <script>
      ...
      if (isConfirm) {
        ...
        $('.userInfo').click(function (e) { 
            ...
            if($.trim(user_id) != ''){
                window.location.href = APP_URI+"/admin/"+user_id+"/user-information";
            }
        });
        ...
        $(".category_status").click(function(){
            ...
            $.ajax({
                    type: "POST",
                    url: APP_URI+"/admin/category-status-update",
                    data: {id: id, update :update, _token : token },
                    success: function (response) {
                        if(response.status == 1)
                        {
            ...
            swal({
                ...
                if (isConfirm) {
                        $.ajax({
                            type: "POST",
                            url: APP_URI+"/admin/category-delete",
            ...
            $("#category,#goal").on('change',function(){
                ...
                if($.trim(cat_id) != '' && $.trim(goal_id) != ''){
                    $.ajax({
                        type: "POST",
                        url: APP_URI+"/admin/fetch-excercise",
                        data: {
                            cat_id:cat_id,
                            goal_id:goal_id,
                            _token : token
            ...
            $('.pack_status').click(function () { 
                ...
                $.ajax({
                        type: "POST",
                        url: APP_URI+"/admin/pack-status-update",
                        data: {id: id, update :update, _token : token },
                        success: function (response) {
                            if(response.status == 1)
                            {
            ...
            swal({
                ...
                if (isConfirm) {
                        $.ajax({
                            type: "POST",
                            url: APP_URI+"/admin/package-delete",
            ...
            $('.packInfo').click(function (e) { 
                ...
                if($.trim(pack_id) != ''){
                    window.location.href = APP_URI+"/admin/"+pack_id+"/package-details";
                }
        ...
        /************* Goal jquery Start   **************/
            ...
            $(".goal_status").click(function(){
                ...
                $.ajax({
                        type: "POST",
                        url: APP_URI+"/admin/goal-status-update",
                        data: {id: id, update :update, _token : token },
                        success: function (response) {
                            if(response.status == 1)
                            {
            ...
            $('.save_changes_excercise').click(function (e) { 
                ...
                $.ajax({
                    type: "POST",
                    url: APP_URI+"/admin/excercise-update",
                    data: {
                    ...
                    success: function (response) {
                        ...
                        if(response.status == 2){
                            ...
                            if(response.status == 1){
                                ...
                                $("#tr_"+excercise_id).find('.excercise_name').text(response.excercise_name);
            ...
            $.ajax({
                    type: "POST",
                    url: APP_URI+"/admin/excercise-status-update",
                    data: {id: id, update :update, _token : token },
                    success: function (response) {
                        if(response.status == 1)
                        {
            ...
            swal({
                ...
                if (isConfirm) {
                        $.ajax({
                            type: "POST",
                            url: APP_URI+"/admin/excercise-delete",
